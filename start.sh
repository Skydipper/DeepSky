...
case "$1" in
    gpu)
        ...
        docker build --rm -f Dockerfile -t vizzuality/mlnotebooks . && docker run -v ~/Projects/DeepSky:/tf/deepsky  --rm -p 6868:8888 --gpus all -it --name mlnotebooks vizzuality/mlnotebooks
        ;;
    cpu)
